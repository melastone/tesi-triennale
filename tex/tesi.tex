...
- def schietta
- struttura
- com'è che è sicuro? immutabile. crittografia. ognuno ha la sua copia.
- blockchain in azione: miners
- le tecnologie basate su blockchain
- chiusura di quello che abbiamo capito sul suo potenziale!

- com'è che si collega alle piattaforme di crittovalute
(ricordati che blockchain nasce insieme al bitcoin!)
- menzione al Bitcoin
- Ethereum come alternativa
- perchè Ethereum?? vantaggi e possibilità
...
Il processo di validazione dei nuovi blocchi viene realizzato dai miners. Il loro compito è quello di verificare le transazioni proposte, e 
