...
La piattaforma basata su blockchain alla quale faremo riferimento è Ethereum, where registered accounts are not mere balances, but may contain smart contracts, i.e., code that can
perform arbitrary computations.

\section{Ethereum, smart contract e gas}
